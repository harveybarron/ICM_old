...
plt.colorbar()
plt.savefig("ICM_old/images/Apodized mask.png",dpi = 400)
plt.show()
...
plt.colorbar()
plt.savefig('ICM_old/images/map with mask.png', dpi = 400)
plt.show()
...
plt.savefig("ICM_old/images/power_spectrum.png", dpi = 400)
plt.show()
...
plt.savefig("ICM_old/images/PS_pressure.png", dpi = 400)
plt.loglog()
plt.show()