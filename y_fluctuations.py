...
pc = plt.pcolormesh(y_fluc, norm=norm, cmap="RdBu_r")     
plt.imshow(y_fluc, cmap = 'RdBu_r')
plt.colorbar(pc)
...
pc = plt.pcolormesh( normalised_y_fluc, norm=norm, cmap="RdBu_r") 
plt.imshow(normalised_y_fluc, cmap = 'RdBu_r')
plt.colorbar(pc)
